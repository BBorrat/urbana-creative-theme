...
<div id="page" class="site">
	<main class="display-none">
        ...
        <header class="header__desktop__scroll">  

            <div class="header__container__margin">

                <a href="/" class="header__logo-link"><img src="<?php bloginfo('template_directory')?>/assets/images/logo.svg" alt="Logo Urbana Creative" class="header__logo" id="header__logo"></a>
                ...
                <nav class="header__navbar" id="header__navbar">
                    <ul class="header__menu" id="header-menu-container" >
                        ...
                        <li class="header__menu__items"> <a href="/" class="header__menu__item__link link--active">Home</a></li>
