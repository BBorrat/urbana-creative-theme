...
if(is_page("creative-xpert-series")) {
    ...
    <section class="expertise__lightbox__container" id="expertise-lightbox">
        ...
        <div class="expertise__lightbox__content">
            ...
            <div class="expertise__lightbox__slides__and__arrow__container">
                ...
                <div class="expertise__lightbox__slide__container expertise__lightbox__video__slide__container">
                    ...
                    <div class="expertise__lightbox__slides">
                        <img class="expertise__lightbox__slides__img" src="<?php bloginfo('template_directory')?>/assets/images/lightbox-creat-serv-xpert-series-puntas-de-gondola.jpg">
                    </div>
                    <div class="expertise__lightbox__slides display-none">
                        <img class="expertise__lightbox__slides__img" src="<?php bloginfo('template_directory')?>/assets/images/lightbox-creat-serv-xpert-series-mamut.jpg">
                    </div>
                    <div class="expertise__lightbox__slides display-none">
                        <img class="expertise__lightbox__slides__img" src="<?php bloginfo('template_directory')?>/assets/images/lightbox-creat-serv-xpert-series-display-unitario.jpg">
                    </div>
            ...
            <div class="expertise__lightbox__caption__container">
                <p class="expertise__lightbox__caption" id="expertise-lightbox-caption">Xpert Series</p>
