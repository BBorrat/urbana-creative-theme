        ...
        <section class="expertise">
            ...
            <div class="expertise__filter__container__desktop">
                <ul class="expertise__filter__items__container__desktop" id="expertice-filter-item-container">
                    ...
                    <li class="expertise__filter__items__list"><a href="expertise-creative-services" class="expertise__filter__items expertise__expertise expertise__filter__item__active" id="creative-services-menu" data-target="creative-services">Creative Services</a></li>
            ...
            <div class="expertise__filter__container__mobile">
                <div class="expertise__filter__items__container__mobile" id="expertice-filter-item-container">
                    ...
                    <ul class="expertise__filter__items__mobile__inner__container__close" id="expertise-mobile-filter-menu-items">
                        ...
                        <li class="expertise__filter__items__list__mobile" data-target="creative-services"><a href="expertise-creative-services" class="expertise__filter__items__mobile expertise__filter__items__mobile__active">Creative Services</a></li>
            ...
            <div class="expertise__carousel" id="expertise-carousel-cover">
                ...
                <div class="expertise__description__container__mobile" id="expertise-description-container-mobile">
                    ...
                    <div class="expertise__description__item__container__mobile" data-description="creative-services">
                        <h2 class="expertise__description__header__mobile">Creative Services</h2>
                        <div class="expertise__description__copy__container__mobile">
                            <p class="expertise__description__copy__mobile">We've done so much - and continue to evolve our portfolio of expertise - that Creative Services has become a catch-all for the many things we offer our clients. As an extension of their marketing team, we provide an extensive list of support services across every dimension of creative marketing. At the end of the day, Urbana is here to help our clients develop great ideas, sell them internally and then launch them into the marketplace. Whatever that entails…we do.</p>
                        </div>
                    </div>
                ...
                <a href=creative-el-escuadron-del-planchado" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="creative-services">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="creative-primalatte-campaign" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="creative-services">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="creative-sistema-de-accesorios-oster" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="creative-services">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="creative-xpert-series" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="creative-services">
                    <div class="expertise__project-name-button__container">
...
if(is_page("expertise-creative-services")) {
