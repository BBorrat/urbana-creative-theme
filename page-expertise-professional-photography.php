            ...
            <div class="header__container__margin">
                ...
                <nav class="header__navbar" id="header__navbar">
                    <ul class="header__menu" id="header-menu-container" >
                        ...
                        <li class="header__menu__items"> <a href="/a" id="header-menu-item-link" class="header__menu__item__link">Home</a></li>
        ...
        <section class="expertise">
            ...
            <div class="expertise__filter__container__desktop">
                <ul class="expertise__filter__items__container__desktop" id="expertice-filter-item-container">
                    ...
                    <li class="expertise__filter__items__list"><a href="expertise-professional-photography" class="expertise__filter__items expertise__expertise expertise__filter__item__active" id="professional-photography-menu" data-target="professional-photography">Professional Photography</a></li>
                ...
                <div class="expertise__description__container__desktop" id="expertise__description__container__desktop">
                    ...
                    <div class="expertise__description__item__container__desktop" data-description="professional-photography">
                        <h2 class="expertise__description__header__desktop">Professional Photography</h2>
                        <div class="expertise__description__copy__container__desktop">
                            <p class="expertise__description__copy__desktop">Urbana makes the most of every production day by doing video and still photography with the same sets, cast and crew. Our talented creative directors, photographers, stylists, and designers work as one to compose visuals that express powerful ideas and tell compelling visual stories.</p>
                            <p class="expertise__description__copy__desktop">Our team is here to support your full photography production needs, including men’s and women’s editorial, portraiture, fashion, product, food, architecture, real estate, automotive and more. We’ve distinguished ourselves in two areas in particular – food and products – with deep experience creating beautifully styled images for some of the world’s leading kitchen products and home appliances.</p>
                        </div>
                    </div>
            ...
            <div class="expertise__filter__container__mobile">
                <div class="expertise__filter__items__container__mobile" id="expertice-filter-item-container">
                    ...
                    <ul class="expertise__filter__items__mobile__inner__container__close" id="expertise-mobile-filter-menu-items">
                        ...
                        <li class="expertise__filter__items__list__mobile" data-target="professional-photography"><a href="expertise-professional-photography" class="expertise__filter__items__mobile expertise__filter__items__mobile__active">Professional Photography</a></li>
            ...
            <div class="expertise__carousel" id="expertise-carousel-cover">
                ...
                <div class="expertise__description__container__mobile" id="expertise-description-container-mobile">
                    ...
                    <div class="expertise__description__item__container__mobile" data-description="professional-photography">
                        <h2 class="expertise__description__header__mobile">Professional Photography</h2>
                        <div class="expertise__description__copy__container__mobile">
                            <p class="expertise__description__copy__mobile">Urbana makes the most of every production day by doing video and still photography with the same sets, cast and crew. Our talented creative directors, photographers, stylists, and designers work as one to compose visuals that express powerful ideas and tell compelling visual stories.</p>
                            <p class="expertise__description__copy__mobile">Our team is here to support your full photography production needs, including men’s and women’s editorial, portraiture, fashion, product, food, architecture, real estate, automotive and more. We’ve distinguished ourselves in two areas in particular – food and products – with deep experience creating beautifully styled images for some of the world’s leading kitchen products and home appliances.</p>
                        </div>
                    </div>
                ...
                <a href="professional-photography-drinks" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="professional-photography">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="professional-photography-food" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="professional-photography">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="professional-photography-lifestyle" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="professional-photography">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="professional-photography-product" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="professional-photography">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="social-75-anniversary-recipe-videos" target="_top" class="expertise__carousel__item__disabled expertice__carusel__cover" data-item="social-content">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="social-home-made-recipes" target="_top" class="expertise__carousel__item__disabled expertice__carusel__cover" data-item="social-content">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="social-paralax" target="_top" class="expertise__carousel__item__disabled expertice__carusel__cover" data-item="social-content">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="social-why-oster" target="_top" class="expertise__carousel__item__disabled expertice__carusel__cover" data-item="social-content">
                    <div class="expertise__project-name-button__container">
...
if(is_page("expertise-professional-photography")) {
