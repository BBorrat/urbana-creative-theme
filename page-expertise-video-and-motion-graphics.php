        ...
        <section class="expertise">
            ...
            <div class="expertise__filter__container__desktop">
                <ul class="expertise__filter__items__container__desktop" id="expertice-filter-item-container">
                    <li class="expertise__filter__items__list"><a href="expertise-video-and-motion-graphics" class="expertise__filter__items expertise__expertise expertise__filter__item__active" id="video-motion-graphics-menu" data-target="video-motion-graphics">Video + Motion Graphics</a></li>
                    ...
                    <li class="expertise__filter__items__list"><a href="expertise-social-content" class="expertise__filter__items expertise__expertise" id="social-content-menu" data-target="social-content">Social Content</a></li>
                ...
                <div class="expertise__description__container__desktop" id="expertise__description__container__desktop">
                    ...
                    <div class="expertise__description__item__container__desktop" data-description="video-motion-graphics">
                        ...
                        <div class="expertise__description__copy__container__desktop">
                            <p class="expertise__description__copy__desktop">Today, brands can reach their targets through dozens of screens on a daily basis – at home or on the go, from phones and computers to gas stations, digital billboards, in-store displays, taxis, Uber/Lyft, planes and even home appliances.</p>
                            <p class="expertise__description__copy__desktop">Urbana takes your marketing goals and turns them into strategically produced and distributed video content that drives loyalty and engagement. Digital video can span a wide range of forms – social media shorts, long-form scripted content, how-tos, documentary-style interviews and more. It can be as simple or complex as your imagination and budget allow, with motion graphics, animation, after effects and other elements to make it energized and eye-catching.</p>
                            <p class="expertise__description__copy__desktop">Our directors, videographers, camera operators, art directors and other staff are all experts at what they do, with years of experience and a passion for developing beautiful, engaging content that makes our clients shine.</p>
                        </div>
                    </div>
            ...
            <div class="expertise__filter__container__mobile">
                <div class="expertise__filter__items__container__mobile" id="expertice-filter-item-container">
                    ...
                    <ul class="expertise__filter__items__mobile__inner__container__close" id="expertise-mobile-filter-menu-items">
                        <li class="expertise__filter__items__list__mobile" data-target="video-motion-graphics"><a href="expertise-video-and-motion-graphics" class="expertise__filter__items__mobile expertise__filter__items__mobile__active"> Video + Motion Graphics</a></li>
                        ...
                        <li class="expertise__filter__items__list__mobile" data-target="social-content"><a href="expertise-social-content" class="expertise__filter__items__mobile">Social Content</a></li>
            ...
            <div class="expertise__carousel" id="expertise-carousel-cover">
                ...
                <div class="expertise__description__container__mobile" id="expertise-description-container-mobile">
                    ...
                    <div class="expertise__description__item__container__mobile" data-description="video-motion-graphics">
                        ...
                        <div class="expertise__description__copy__container__mobile">
                            <p class="expertise__description__copy__mobile">Today, brands can reach their targets through dozens of screens on a daily basis – at home or on the go, from phones and computers to gas stations, digital billboards, in-store displays, taxis, Uber/Lyft, planes and even home appliances.</p>
                            <p class="expertise__description__copy__mobile">Urbana takes your marketing goals and turns them into strategically produced and distributed video content that drives loyalty and engagement. Digital video can span a wide range of forms – social media shorts, long-form scripted content, how-tos, documentary-style interviews and more. It can be as simple or complex as your imagination and budget allow, with motion graphics, animation, after effects and other elements to make it energized and eye-catching.</p>
                            <p class="expertise__description__copy__mobile">Our directors, videographers, camera operators, art directors and other staff are all experts at what they do, with years of experience and a passion for developing beautiful, engaging content that makes our clients shine.</p>
                        </div>
                    </div>
                    ...
                    <div class="expertise__description__item__container__mobile__disable" data-description="social-content" >
                        <h2 class="expertise__description__header__mobile">Social Content</h2>
                        <div class="expertise__description__copy__container__mobile">
                            <p class="expertise__description__copy__mobile">We can help you create social media content for a wide variety of budgets. Our team of social media content creators can make it easier for you to reach your target audience. We help you and your team achieve (and often exceed) your marketing, sales, and growth goals. Our passion to create amazing content, our commitment to your success, and our seamless fusion of art and technology are some of the things that set us apart. We can help you get your content to the right audience and inspire them to take action.</p>
                            <p class="expertise__description__copy__mobile">We can create:</p>
                            <ul class="expertise__description__copy__mobile">
                                <li>Brand pages</li>
                                <li>Ads</li>
                                <li>Posts</li>
                ...
                <a href="video-oster-blender-with-texture-select-settings" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="video-motion-graphics">
                ...
                <a href="video-coravin-smart-clamps" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="video-motion-graphics">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="video-oster-kitchen-products" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="video-motion-graphics">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="video-calphalon-activesense-blender" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="video-motion-graphics">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="video-foodsaver" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="video-motion-graphics">
                    <div class="expertise__project-name-button__container">
                ...
                <a href="video-nuyu-health-o-meter" target="_top" class="expertise__carousel__item expertice__carusel__cover" data-item="video-motion-graphics">
                    <div class="expertise__project-name-button__container">
...
if(is_page("expertise-video-and-motion-graphics")) {
