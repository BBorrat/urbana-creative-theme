...
if(is_page("video-calphalon-activesense-blender")) {
        ...
        <div class="expertise__lightbox__content">
            ...
            <div class="expertise__lightbox__video__slides__and__arrow__container">
                ...
                <div class="expertise__lightbox__video__slide__container">
                    ...
                    <video class="expertise__lightbox__video__slides"  width="540px" controls>
                        <source class="expertise__lightbox__video__slides__img" src="<?php bloginfo('template_directory')?>/assets/videos/lightbox-540p-calphalon-activesense-blender.mp4">
                    </video>
            ...
            <div class="expertise__lightbox__caption__container">
                <p class="expertise__lightbox__caption" id="expertise-lightbox-caption">Calphalon | ActiveSense Blender</p>
