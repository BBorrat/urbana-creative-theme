...
if(is_page("video-coravin-smart-clamps")) {
    ...
    <section class="expertise__lightbox__container" id="expertise-lightbox">
        ...
        <div class="expertise__lightbox__content">
            ...
            <div class="expertise__lightbox__video__slides__and__arrow__container">
                ...
                <div class="expertise__lightbox__video__slide__container">
                    <video class="expertise__lightbox__video__slides"  width="540px" controls>
                        <source class="expertise__lightbox__video__slides__img" src="<?php bloginfo('template_directory')?>/assets/videos/lightbox-540p_coravin_smart_clamps.mp4">
                    </video>
                </div>
            ...
            <div class="expertise__lightbox__caption__container">
                <p class="expertise__lightbox__caption" id="expertise-lightbox-caption">Coravin | Smart clamps</p>
