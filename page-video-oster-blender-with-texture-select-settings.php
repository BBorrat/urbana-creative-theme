...
if(is_page("video-oster-blender-with-texture-select-settings")) {
		...
		<div class="expertise__lightbox__content">
			...
			<div class="expertise__lightbox__video__slides__and__arrow__container">
				...
				<div class="expertise__lightbox__video__slide__container">
					...
					<video class="expertise__lightbox__video__slides" width="720px" controls>
						<source class="expertise__lightbox__slides__img" src="<?php bloginfo('template_directory')?>/assets/videos/lightbox-540p-oster_blender_with_texture_select_setting.mp4" type="video/mp4">
						<source class="expertise__lightbox__slides__img" src="<?php bloginfo('template_directory')?>/assets/videos/lightbox-540p-oster_blender_with_texture_select_setting.webm" type="video/webm">
					</video>
			...
			<div class="expertise__lightbox__caption__container">
				<p class="expertise__lightbox__caption" id="expertise-lightbox-caption">Oster® Blender with Texture Select Settings</p>
